<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div id="imageDisplay" style="margin-top: 20px;">
            ...
            <img id="imagePreview" src="https://img.tripi.vn/cdn-cgi/image/width=700,height=700/https://gcs.tripi.vn/public-tripi/tripi-feed/img/473471zRM/image-59-hinh-anh-chim-bo-cau-dep-hoa-binh-tuoi-tan-nhat-hien-nay-167637166079625.jpg" alt="Image Preview" class="rounded-full w-32 h-32 object-cover mx-auto" style="display: block;">
